...
public class CronExpression implements Serializable, Cloneable {
     ...
     *         expression
     */
    public static final boolean isValidExpression(String cronExpression) {
    ...
    /**
     * Builds a cron expression for the next minute 
     * 
     * @return a String with the expression for next minute. Good for one run
     */
    public static String nextMinute() 
    {
    	Calendar cal = Calendar.getInstance();
    	cal.setTimeInMillis(System.currentTimeMillis() + 120000); //Add 2 minutes = 2 * 60000 milliseconds
    	...
    	int month = cal.get(Calendar.MONTH) + 1; //January is 0 in Gregorian calendar
		sb.append(month).append(' ');
    	sb.append("? "); //Day of week, this will be any day of week
